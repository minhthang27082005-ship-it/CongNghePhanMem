...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        // Gọi hàm xóa (Hàm này trả về void, không gán vào biến boolean)
        productD.deleteProductById(Integer.parseInt(id));
        
        // Luôn đặt thông báo vào Session vì chúng ta thực hiện Redirect
        request.getSession().setAttribute("successMessage", "Đã xóa sản phẩm thành công!");
    } catch (Exception e) {
