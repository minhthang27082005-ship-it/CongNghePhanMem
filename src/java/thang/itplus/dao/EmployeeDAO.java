...
public class EmployeeDAO {
    ...
    // Các câu lệnh SQL
    private static final String SELECT_ALL_EMPLOYEES = "SELECT employee_id, user_id, name, email, phone, address, position, salary, hire_date, status FROM employees";
    ...
    public boolean updateEmployeeProfile(Employee employee, User user) throws SQLException {
        DBContext dbContext = new DBContext();
        Connection connection = null;
        ...
        try {
            ...
            // 2. Cập nhật bảng users (nếu user_id tồn tại)
